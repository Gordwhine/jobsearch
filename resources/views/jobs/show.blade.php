    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2>{{$job->title}}</h2>
                        <div>
                        <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span>{{$job->tags}}</span>
                        ...
                        @else
                        <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-danger">{{$job->job_type}}</span></span>
                        @endif
                        </div>
                    </div>
                </div>
            ...
            {{-- <div class="col-lg-4">
                <div class="row">
                    <div class="col-6">
                        <a href="{{ route('edit', $job->id) }}" class="btn btn-block btn-info btn-md">Edit Job</a>
                    </div>
                    <div class="col-6">
                        <form method="post" action="{{ route('delete', $job->id) }}">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-block btn-danger btn-md">Delete Job</button>
                        </form>
                    </div>
                </div>
            </div> --}}
        ...
        <div class="col-lg-8">
            <div class="mb-5">
                <figure class="mb-5">
                    <img src="{{ $job->logo ? asset('storage/' . $job->logo) : asset('frontend/images/job_logo_1.jpg') }}" alt="Image" class="img-fluid rounded">
                </figure>
        ...
        <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
                ...
                <ul class="list-unstyled pl-3 mb-0">
                    <li class="mb-2"><strong class="text-black">Published on:</strong> {{$job->created_at->toFormattedDateString()}}</li>
